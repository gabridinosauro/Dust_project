...
#####Venn Diagram
list_increasing = list(`Coarse SS` =increasing500, `Medium SS` = increasing75, `Fine SS` =  increasing25, `WT` = increasingDG )
a = ggvenn(
  list_increasing, 
...
#####Venn Diagram
list_decreasing = list(`Coarse SS` =decreasing500, `Medium SS` = decreasing75, `Fine SS` =  decreasing25, `WT` = decreasingDG )
b  = ggvenn(
  list_decreasing, 
  fill_color = c("#0073C2FF", "#EFC000FF", "#868686FF", "#CD534CFF"),
  stroke_size = 0.5, set_name_size = 4
